...
le même objectif donné. \cite{InternetW0} Elle s'applique également aux fonctions cognitives qui
...
par les médias, qui en font \emph{un buzzword}, et \emph{désinforment parfois plus} qu'il n'informent.
...
sur son application au domaine informatique en particulier, bien que son utilisation se fasse à travers divers
domaines tels que les mathématiques, la psychologie ou la philosophie.
