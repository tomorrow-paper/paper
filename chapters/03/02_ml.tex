...
\subsection*{Apprentissage non supervisé, GAN}
...
\paragraph{Réseau stratégique} L'entraînement de ce réseau a nécessité deux étapes de machine learning. Une première partie a 
...
d'amateur - environ 3\up{ème} dan sur le KGS Go Server \cite{AlphaGo1}.
...
\paragraph{Les résultats} En 2015, AlphaGo est la première machine à remporter des parties contre un professionnel, Fan H\textsc{ui} (2\up{ème} dan professionnel
français). Il est ensuite le gagnant de parties importantes : contre Lee S\textsc{edol} (9\up{ème} dan coréen), considéré comme un des meilleurs professionnels
au monde, puis contre Ke J\textsc{ie} (9\up{ème} dan chinois) qui est alors classé 1\up{er} au niveau mondial. Il gagne aussi dans 99.8\% des cas contre
...
\subsection*{AlphaGo Zero, la révolution}
