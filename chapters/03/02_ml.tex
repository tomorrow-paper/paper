...
\paragraph{Références} \cite{AlphaGo0} \cite{AlphaGo1} \cite{MachineLearning0} \cite{Internet4} \cite{Internet5}
...
machine de se rendre compte \emph{elle-même} de la meilleure manière de faire cette affectation ? \cite{MachineLearning0} C'est exactement le propos du Machine
...
situations, la majorité arrive à s'accorder sur un nombre restreint de solutions (une, deux) permettant de résoudre \emph{la majorité} des cas.
