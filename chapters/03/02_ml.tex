...
\paragraph{Références} \cite{AlphaGo0} \cite{AlphaGo1} \cite{AlphaGo2} \cite{Brain0} \cite{Brain1}
 \cite{Heuristics0} \cite{MachineLearning0} \cite{MachineLearning2} \cite{MachineLearning3}
 \cite{MachineLearning4} \cite{University0}
...
\paragraph{Apprentissage non supervisé et par renforcement} Explications sommaires du principe pour les deux --
